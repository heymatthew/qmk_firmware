 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Down |  Up  | GUI  |Lower | Space|Shift |Raise | Ctrl | Left | Right| Alt  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_DOWN, KC_UP,   KC_LGUI, LOWER,   KC_SPC,  KC_LSFT, RAISE,   KC_LCTL, KC_LEFT, KC_RGHT, KC_LALT
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
